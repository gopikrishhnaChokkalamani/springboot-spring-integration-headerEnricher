package com.springboot.integration.headerEnricher.service;
...
public class IntegrationService {
	...
	@ServiceActivator(inputChannel = "integration.additionalParam.gateway.channel")
	public void processAnotherArgumentMessage(Message<?> message) throws MessagingException {
		System.out.println(message);
	}
}